...
class AccountInvoice(models.Model):
    ...
    def _compute_amount(self):
        for move in self:
            ...
            move.amount_subtotal = move.amount_total + amount_discount
    ...
    #         move.amount_total_signed = abs(total) if move.move_type == 'entry' else -total
    #         move.amount_residual_signed = total_residual
    #         move.amount_subtotal = move.amount_total_signed  + amount_discount
    ...
    amount_subtotal = fields.Monetary(string='Net Total', readonly=True, compute='_compute_amount',
    ...
    def _compute_tax_totals_json(self):
        ...
        for move in self:
            ...
            amount_subtotal = formatLang(self.env, move.amount_subtotal, currency_obj=move.currency_id)
            amount_discount = formatLang(self.env, move.amount_discount, currency_obj=move.currency_id)
